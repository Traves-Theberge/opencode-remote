...
- Expanded docs into a deeper wiki-first structure with end-to-end navigation:
  - new deepwiki-style guide: `docs/wiki/End-to-End-Guide.md`
...
- root: `1.2.7`
- workspaces: `0.2.7` (`daemon`, `cli`, `tui`, `bridge`)
